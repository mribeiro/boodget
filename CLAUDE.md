...
- **Last applied migration**: `039_add_cycle_weekend_adjustment`. **Next id must be `040_...`**
...
PATCH  /api/dossiers/:id/cycles/:cycleId      { year?, month?, salary?, previous_balance?, is_closed?, final_real_balance?, resolve_overlap? }
