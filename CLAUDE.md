...
- **Last applied migration**: `033_add_ai_advisor`. **Next id must be `034_...`**
...
PATCH  /api/dossiers/:id/settings   { cycle_start_day?, capital_snapshot_warning_day?,
                                       ...
                                       ai_model?, reference_salary?, loans_max_salary_pct? }
