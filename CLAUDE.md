...
│   │   ├── utils/numbers.js, loanMath.js, cycleDates.js  # formatNumber/parseDecimalInput, loan amortization math, weekend-adjusted cycle date math
│   │   ├── pages/
...
- **Last applied migration**: `042_add_balance_as_of_to_loans`. **Next id must be `043_...`**
