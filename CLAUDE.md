...
- **Last applied migration**: `034_add_ai_settings_to_dossiers`. **Next id must be `035_...`**
...
PATCH  /api/dossiers/:id/settings   { cycle_start_day?, capital_snapshot_warning_day?,
                                       ...
                                       ai_enabled?, ai_model?, ai_api_key?, reference_salary?, loans_max_salary_pct? }
