...
- **Last applied migration**: `032_add_loans_max_salary_pct_to_dossiers`. **Next id must be `033_...`**
...
PATCH  /api/dossiers/:id/settings   { cycle_start_day?, capital_snapshot_warning_day?,
                                       ...
                                       reference_salary?, loans_max_salary_pct? }
