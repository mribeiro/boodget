...
│   │       ├── car-expenses/CarExpensesTab.jsx, CarFormModal.jsx, CarDetail.jsx, CarMonthFormModal.jsx
...
- **Last applied migration**: `044_add_car_id_to_expense_templates`. **Next id must be `045_...`**
...
DELETE /api/dossiers/:id/cars/:carId       (hard delete — cascades car_months, nulls car_id on linked template items)
