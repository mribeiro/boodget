...
- Two sections — "Expenses" and "Distributions" — each a `CollapsibleSection` (Section 6.8) with a `faReceipt`/`faArrowsSplitUpAndLeft` icon and an item-count badge; Expenses open by default.
